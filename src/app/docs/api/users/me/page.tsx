...
import { apiError400ModelRows, apiError401ModelRows, apiUsersMe403ErrorModelRows, apiUsersMePatchBodyModelRows, tableHeader } from "@/constants/models";
import Link from "next/link";

export default function UsersMeDocs() {
    return (
        <>
            <ApiBadge path="/users/me" type="GET" />
            ...
            <h3 className="py-4 text-2xl">
                Model:{" "}
                <Link href="/docs/models/selfUser#SelfUser" className="link text-accent font-mono text-xl">
                    SelfUser
                </Link>
            </h3>
            ...
            <ApiBadge path="/users/me" type="PATCH" />

            <h3 className="py-4 text-3xl">Body</h3>

            <ModelTable header={tableHeader} rows={apiUsersMePatchBodyModelRows} />
            ...
            <ModelTable header={tableHeader} rows={apiUsersMe403ErrorModelRows} />

            <Divider large />

            <ApiBadge path="/users/me" type="DELETE" />
